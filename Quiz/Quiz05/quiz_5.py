    ...
    with open(file_path, newline='') as csvfile:
        ...
        for attribute in attributes:
            ...
            for i in range(1, 6):
                ...
                if ratio > 1:
                    ratios.append((round(ratio, 6), f"{attribute.capitalize()} in category {i} (1 lowest, 5 highest)"))
        ...
        for attribute in ['cholesterol', 'glucose']:
            ...
            for i in range(3):
                ...
                if ratio > 1:
                    ratios.append((round(ratio, 6), f"{attribute.capitalize()} in category {i+1} (1 lowest, 3 highest)"))
        ...
        for attribute in ['smoking', 'drinking', 'being active']:
            ...
            if ratio > 1 and attribute == 'being active':
                ratios.append((round(ratio, 6), f'{attribute.capitalize()}'))
            if ratio > 1 and attribute != 'being active':
                ratios.append((round(ratio, 6), f'Not {attribute}'))   
            if ratio_i > 1 and attribute != 'being active':
                ratios.append((round(ratio_i, 6), f'{attribute.capitalize()}'))
            if ratio_i > 1 and attribute == 'being active':
                ratios.append((round(ratio_i, 6), f'Not {attribute}'))
